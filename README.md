# Cron Master | Crontab Expression Parser & Translator

> Translate and validate crontab expressions into plain human English online. Supports minute, hour, day, month, and day-of-week syntax offline.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/cron-master/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/cron-master/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/cron-master/](https://cig13zs.github.io/cron-master/) or install the offline Chrome Extension package.
...
Enter any standard 5-part cron expression (e.g. */15 9-17 * * 1-5) to view an intuitive English translation of its execution schedule.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/cron-master.git
   ```
